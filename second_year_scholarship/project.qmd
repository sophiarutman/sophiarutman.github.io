...
Upon observing the two correlation matrices above, a few columns have some of the noticably strongest correlations: the unknown columns. For example, location unknown and attack context unknown have a correlation of 0.59. In addition, attack context unknown and motive unknown have a correlation of 0.21. In the first zoomed in correlation matrix, gender unknown has strong correlations with United Nations aid workers involved in incidents, total killed, total wounded, and total affected. All four of these correlations are above 0.5, with the correlation between gender unknown and total affected being an extreme 0.87. 
